 ...
 *  applicable laws. 
 */
ej.Autocomplete && (ej.Autocomplete.Locale["zh-CN"] = {
	addNewText: "添新",
	emptyResultText: "没有建议",
	actionFailure: "指定字段中不定的数据源存在",
	watermarkText: " "
});
ej.ColorPicker && (ej.ColorPicker.Locale["zh-CN"] = {
	buttonText: {
		apply: "应用",
		cancel: "取消",
		swatches: "色板"
...
ej.CurrencyTextbox && (ej.CurrencyTextbox.Locale["zh-CN"] = {
	watermarkText: "输入值"
});
ej.DatePicker && (ej.DatePicker.Locale["zh-CN"] = {
	watermarkText: "选择日期",
	buttonText: "今天"
});
...
ej.DateTimePicker && (ej.DateTimePicker.Locale["zh-CN"] = {
...
ej.datavisualization && ej.datavisualization.Diagram && (ej.datavisualization.Diagram.Locale["zh-CN"] = {
	cut: "切",
	copy: "复制",
	paste: "糊",
	undo: "解开",
...
ej.Dialog && (ej.Dialog.Locale["zh-CN"] = {
	tooltip: {
		close: "关闭",
		collapse: "崩溃",
		restore: "恢复",
...
ej.DropDownList && (ej.DropDownList.Locale["zh-CN"] = {
	emptyResultText: "没有建议",
	watermarkText: " "
});
ej.ExcelFilter && (ej.ExcelFilter.Locale["zh-CN"] = {
...
ej.FileExplorer && (ej.FileExplorer.Locale["zh-CN"] = {
...
ej.Gantt && (ej.Gantt.Locale["zh-CN"] = {
	emptyRecord: "无记录可显示",
	alertTexts: {
		indentAlert: "有没有横道记录被选中进行降级",
		outdentAlert: "有没有横道记录被选择执行升级",
		predecessorEditingValidationAlert: "循环相关性发生，请检查的依赖",
		predecessorAddingValidationAlert: "填写依赖表中的所有列",
...
ej.mobile !== undefined && ej.mobile.Grid !== undefined && (ej.mobile.Grid.Locale["zh-CN"] = {
	emptyResult: "无记录可显示",
...
ej.mobile !== undefined && ej.mobile.DatePicker !== undefined && (ej.mobile.DatePicker.Locale["zh-CN"] = {
	confirmText: "做",
	Windows: {
		cancelText: "取消",
		headerText: "选择日期",
...
ej.mobile !== undefined && ej.mobile.TimePicker !== undefined && (ej.mobile.TimePicker.Locale["zh-CN"] = {
	confirmText: "做",
	AM: "上午",
	PM: "下午",
	Android: {
...
ej.NumericTextbox && (ej.NumericTextbox.Locale["zh-CN"] = {
	watermarkText: "输入值"
});
ej.PivotChart && (ej.PivotChart.Locale["zh-CN"] = {
	Measure: "测量",
	Row: "行",
	Column: "柱",
	Expand: "扩大",
...
ej.PivotClient && (ej.PivotClient.Locale["zh-CN"] = {
...
ej.PivotGauge && (ej.PivotGauge.Locale["zh-CN"] = {
	RevenueGoal: "收入目标",
	RevenueValue: "收入值"
});
ej.Pager && (ej.Pager.Locale["zh-CN"] = {
	pagerInfo: "第{0}页  /  共{1}页（{2}条记录）",
...
ej.PdfViewer && (ej.PdfViewer.Locale["zh-CN"] = {
	toolbar: {
		print: {
			headerText: "打印",
			contentText: "打印PDF文档。"
...
ej.PercentageTextbox && (ej.PercentageTextbox.Locale["zh-CN"] = {
	watermarkText: "输入值"
});
ej.PivotGrid && (ej.PivotGrid.Locale["zh-CN"] = {
	Total: "總金額",
	GrandTotal: "總計",
	DoesNotBeginsWith: "未開始使用",
	DoesNotEndsWith: "不會結尾",
...
ej.PivotPager && (ej.PivotPager.Locale["zh-CN"] = {
	SeriesPage: "系列的页面",
	CategoricalPage: "分类页",
	Error: "错误",
	OK: "“确定” 按钮",
...
ej.PivotSchemaDesigner && (ej.PivotSchemaDesigner.Locale["zh-CN"] = {
	DoesNotBeginsWith: "未開始使用",
	DoesNotEndsWith: "不會結尾",
	DoesNotContains: "不包含",
	DoesNotEquals: "不就等於",
...
ej.datavisualization && ej.datavisualization.RangeNavigator && (ej.datavisualization.RangeNavigator.Locale["zh-CN"] = {
	intervals: {
		quarter: {
			longQuarters: "25美分硬币，",
			shortQuarters: "Q"
...
ej.datavisualization && ej.datavisualization.Chart && (ej.datavisualization.Chart.Locale["zh-CN"] = {
	zoomIn: "放大",
	zoomOut: "缩小",
	zoom: "放大",
	pan: "泛",
...
ej.datavisualization && ej.datavisualization.Map && (ej.datavisualization.Map.Locale["zh-CN"] = {
	zoomIn: "放大",
	zoomOut: "缩小",
	panTop: "潘顶",
	panBottom: "锅底",
...
ej.ReportViewer && (ej.ReportViewer.Locale["zh-CN"] = {
	toolbar: {
		print: {
			headerText: "打印",
			contentText: "打印报告。"
...
ej.Ribbon && (ej.Ribbon.Locale["zh-CN"] = {
...
ej.Kanban && (ej.Kanban.Locale["zh-CN"] = {
	EmptyCard: "没有要显示的即时贴",
	SaveButton: "保存",
	CancelButton: "取消",
	EditFormTitle: "详细信息 ",
...
ej.Schedule && (ej.Schedule.Locale["zh-CN"] = {
...
ej.Spreadsheet && (ej.Spreadsheet.Locale["zh-CN"] = {
	Cut: "Cắt tỉa",
	Copy: "bản sao",
...
ej.TreeGrid && (ej.TreeGrid.Locale["zh-CN"] = {
	toolboxTooltipTexts: {
		addTool: "添加",
		editTool: "编辑",
		updateTool: "更新",
...
ej.Uploadbox && (ej.Uploadbox.Locale["zh-CN"] = {
	buttonText: {
		upload: "上传",
		browse: "浏览",
		cancel: "取消",
...
ej.Tile && (ej.Tile.Locale["zh-CN"] = {
	captionText: "文本"
});
ej.ListView && (ej.ListView.Locale["zh-CN"] = {
	headerTitle: "标题",
