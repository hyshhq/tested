...
var projectResources = [
    ...
    { resourceId: 3, resourceName: 'Testing Engineer' },
    { resourceId: 4, resourceName: 'Testing Engineer' }
];

var projectResources1 = [
   { resourceName: true },
    { resourceName: false },
    {resourceName: 3 },
    {resourceName: 4 }
        ...
        subtasks: [
            {
                ...
                endDate: '02/07/2014',
                subtasks: [
                    { taskID: 3, taskName: 'Plan timeline', startDate: '02/03/2014', endDate: '02/07/2014', duration: 5, progress: '100', resourceId: [1], notes1: '<b>testing</b>', },
